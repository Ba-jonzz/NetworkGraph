...
const MyApp = () => {
  return (
    <div className="App">
      <NetworkGraph data={dataElements} onHoverLine={(event) => (<>Tooltip Link </>)} onHoverNode={(event) => (<>Tooltip Node</>)}  />
    </div>
  );
}
...
const dataElements = [
  ...
  { data: {  id: '1', source: 'one', target: 'two', label: 'Edge from Node1 to Node2' ,size:  sizeEdge.sm, color:colorEdge.black }},
  { data: {  id: '2',source: 'two', target: 'three', label: 'Edge from Node2 to Node3' ,size:sizeEdge.sm ,color:colorEdge.black }},
  { data: {  id: '3',source: 'three', target: 'four', label: 'Edge from Node3 to Node4' ,size: sizeEdge.md,color:colorEdge.black }},
  { data: {  id: '4',source: 'four', target: 'five', label: 'Edge from Node4 to Node5' ,size:sizeEdge.md ,color:colorEdge.black }},
  { data: {  id: '5',source: 'five', target: 'six', label: 'Edge from Node5 to Node6' ,size: sizeEdge.lg ,color:colorEdge.black }},
  { data: {  id: '6',source: 'six', target: 'seven', label: 'Edge from Node6 to Node7' ,size: sizeEdge.lg,color:colorEdge.black }},
  { data: {  id: '7',source: 'seven', target: 'eight', label: 'Edge from Node7 to Node8' ,size: sizeEdge.sm,color:colorEdge.green }},
  { data: {  id: '8',source: 'eight', target: 'nine', label: 'Edge from Node8 to Node9' ,size: sizeEdge.sm,color:colorEdge.green }},
  { data: {  id: '9',source: 'nine', target: 'ten', label: 'Edge from Node9 to Node10' ,size: sizeEdge.md,color:colorEdge.green }},
  { data: {  id: '10',source: 'ten', target: 'eleven', label: 'Edge from Node10 to Node11' ,size: sizeEdge.md,color:colorEdge.green }},
  { data: {  id: '11',source: 'eleven', target: 'twelve', label: 'Edge from Node11 to Node12' ,size: sizeEdge.lg,color:colorEdge.green }},
  { data: {  id: '13',source: 'one', target: 'four', label: 'Edge from Node12 to Node1' ,size: sizeEdge.lg,color:colorEdge.green}},
  { data: {  id: '14',source: 'four', target: 'seven', label: 'Edge from Node13 to Node4' ,size: sizeEdge.lg,color:colorEdge.green}},
  { data: {  id: '15',source: 'seven', target: 'ten', label: 'Edge from Node14 to Node7' ,size: sizeEdge.lg,color:colorEdge.green}},
  { data: {  id: '16',source: 'ten', target: 'thirteen', label: 'Edge from Node15 to Node10' ,size: sizeEdge.lg,color:colorEdge.green}},
  { data: {  id: '17',source: 'thirteen', target: 'sixteen', label: 'Edge from Node16 to Node13' ,size: sizeEdge.lg,color:colorEdge.green}},
  { data: {  id: '18',source: 'sixteen', target: 'nineteen', label: 'Edge from Node17 to Node16' ,size: sizeEdge.lg,color:colorEdge.green}},
  { data: {  id: '19',source: 'nineteen', target: 'twenty', label: 'Edge from Node18 to Node19' ,size: sizeEdge.lg,color:colorEdge.green}},
  { data: {  id: '20',source: 'twenty', target: 'one', label: 'Edge from Node19 to Node20' ,size: sizeEdge.lg,color:colorEdge.green}},
